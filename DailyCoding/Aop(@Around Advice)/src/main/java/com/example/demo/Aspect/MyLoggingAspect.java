...
public class MyLoggingAspect {
	...
	@Around("execution(* com.example.demo.service.TrafficFortuneService.getFortune(..))") 
		public Object aroundFortune(ProceedingJoinPoint proceedingJoinPoint)throws Throwable{
			MethodSignature methodSignature = (MethodSignature)proceedingJoinPoint.getSignature();
			System.out.println("Executing -->" + methodSignature);
			Object  res = null;
			...
			res = proceedingJoinPoint.proceed();
				...
				System.out.println("some issue has occued" + exc.getMessage());
